      ...
      toolResult(async () => {
        ...
        return {
          ...
          data: {
            connection,
            ...described,
            properties: propFit.rows,
            navigationProperties: navFit.rows,
            ...(truncated
              ? {
                  truncated: true,
                  propertiesTotal: described.properties.length,
                  navigationPropertiesTotal: described.navigationProperties.length,
                }
              : {}),
          },
        }
